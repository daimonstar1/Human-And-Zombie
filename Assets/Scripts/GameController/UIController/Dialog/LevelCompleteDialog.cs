...
public class LevelCompleteDialog : DialogController
{
    ...
    public void ShareFacebookButton_OnClick()
    {
        ...
        Master.PlaySoundButtonClick();
        FacebookController.Instance.ShareLink("", "I have completed level " + Master.LevelData.currentLevel + " | SWAT: Zombie Defense", "Let's play \"SWAT: Zombie Defense\" and lead your SWAT team to defeat the Zombies!!!",
            FacebookController.Instance.linkImageShareLevelComplete);
    }
